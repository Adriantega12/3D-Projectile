...
void GraphicsComponent::drawPoint( SDL_Renderer*& renderer, int x, int y, const Uint8 color[] ) {
	SDL_SetRenderDrawColor( renderer, color[0], color[1], color[2], color[3] );
	SDL_RenderDrawPoint( renderer, x, y );
	}

void GraphicsComponent::drawLine( SDL_Renderer*& renderer, int x0, int y0, int x1, int y1, const Uint8 color[] ) {
	SDL_SetRenderDrawColor( renderer, color[0], color[1], color[2], color[3] );
